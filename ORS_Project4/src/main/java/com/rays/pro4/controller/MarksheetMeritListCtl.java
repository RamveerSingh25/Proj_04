...
public class MarksheetMeritListCtl extends BaseCtl{
	 ...
	 private static Logger log = Logger.getLogger(MarksheetMeritListCtl.class);
	    ...
	    protected void doGet(HttpServletRequest request,
	        ...
	        System.out.println("inside doget of MMListCtl");
	        ...
	        List list;
	        System.out.println("Executed populatebean, created marksheetmodel object");
	        try {
	            list = model.getMeritList(pageNo, pageSize);
	            ServletUtility.setList(list, request);
	            System.out.println("called getmeritlist of model and holded in list, servletutility.setlist");
	    ...
	    protected void doPost(HttpServletRequest request,
	            HttpServletResponse response) throws ServletException, IOException {
	        log.debug("MarksheetMeritListCtl doGet Start");
	        System.out.println("inside dopost of MMListCtl");
	        String op = DataUtility.getString(request.getParameter("operation"));
