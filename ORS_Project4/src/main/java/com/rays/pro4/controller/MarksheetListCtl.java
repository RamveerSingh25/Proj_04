...
public class MarksheetListCtl extends BaseCtl {
	...
	protected void preload(HttpServletRequest request) {
		System.out.println("inside Mlist preload");
	...
	protected BaseBean populateBean(HttpServletRequest request) {
		System.out.println("inside Mlist populate");
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		System.out.println("inside Mlist doget");
		List nextList = null;
		int pageNo = 1;
		...
		MarksheetModel model = new MarksheetModel();
		try {
			System.out.println("inside try of doget of Mlist");
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		System.out.println("inside dopost of Mlist");
		...
		if (OP_SEARCH.equalsIgnoreCase(op)) {
			...
			if (ids != null && ids.length > 0) {
				System.out.println("inside delete of dopost of Mlist");
