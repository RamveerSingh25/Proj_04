...
public class MarksheetModel {
	...
	public List getMeritList(int pageNo, int pageSize) throws ApplicationException {
		...
		StringBuffer sql = new StringBuffer(
				"SELECT ID,ROLL_NO,NAME,PHYSICS,CHEMISTRY,MATHS,(PHYSICS+CHEMISTRY+MATHS) AS total FROM ST_MARKSHEET WHERE PHYSICS>33 AND MATHS>33 AND CHEMISTRY >33  ORDER BY TOTAL DESC");
