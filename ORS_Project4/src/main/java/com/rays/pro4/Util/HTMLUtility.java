...
public class HTMLUtility {
	...
	public static String getList(String name, String selectedVal,
        ...
        StringBuffer sb = new StringBuffer(
                "<select style='width: 190px;  height: 20px;' class='form-control' name='" + name + "'>");
        ...
        if (select)
        {
        	sb.append("<option style='width: 190px;  height: 20px;' selected value=''>--------------Select--------------------`</option>");
        }
...
;
 ...
 public static String getList(String name, String selectedVal, List list) {
        ...
        StringBuffer sb = new StringBuffer("<select style='width: 190px;  height: 20px;' class='form-control' name='" + name + "'>");
