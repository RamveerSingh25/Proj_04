...
<body>
 ...
 <div align="center">
    <h1 align="center">Forgot your password ?</h1>
                 <lable>Submit your registered Email address and we'll send your password !!</lable><br><br>
	...
	<div align="center">
            ...
            <table align="center">
                ...
                <td><input type="text" name="login" size="23" autocomplete="off" placeholder="Enter Your Valid  Email Id" value="<%=ServletUtility.getParameter("login", request)%>"></td>
