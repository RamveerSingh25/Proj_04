...
<table>
 ...
 <tr><th style="padding: 3px"></th></tr>   
	...
	<tr><th align="left">Subject Name<span style="color: red">*</span> :</th>
 ...
 <tr><th style="padding: 3px"></th></tr>  
	...
	<td> <input type="text" readonly="readonly" id="udatee" size="23" placeholder="Select Date" name="ExDate" value="<%=DataUtility.getDateString(bean.getExamDate()) %>">
