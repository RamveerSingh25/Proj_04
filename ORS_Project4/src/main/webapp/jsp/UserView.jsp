   ...
   <center>
    ...
    <tr><th style="padding: 3px"></th></tr>          
                ...
                <tr>
                    ...
                    <td><input type="text" name="login" placeholder="Enter Email Id" size="23" value="<%=DataUtility.getStringData(bean.getLogin())%>"
    ...
    <tr><th style="padding: 3px"></th></tr>          
                ...
                <tr>
                    ...
                    <td><input type="password" name="password" placeholder="Enter Password" size="23"value="<%=DataUtility.getStringData(bean.getPassword())%>"></td>
    ...
    <tr><th style="padding: 3px"></th></tr>          
                ...
                <tr>
                    ...
                    <td><input type="password" name="confirmPassword" placeholder="Re-Enter Password" size="23" value="<%=DataUtility.getStringData(bean.getConfirmPassword())%>"></td>
    ...
    <tr><th style="padding: 3px"></th></tr>          
                ...
                <tr>
                    ...
                    <td><input type="text" name="dob" placeholder="Enter Date Of Birth" size= "23" readonly="readonly" id="udatee" value="<%=DataUtility.getDateString(bean.getDob())%>"></td>
    ...
    <tr><th style="padding: 3px"></th></tr>          
                ...
                <tr>
                    ...
                    <td><input type="number" style="width:190px" name="mobileNo" maxlength="10" placeholder="Enter Mobile No" size= "23" value="<%=DataUtility.getStringData(bean.getMobileNo())%>"></td>
