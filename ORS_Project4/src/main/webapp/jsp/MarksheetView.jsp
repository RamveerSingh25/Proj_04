...
<center>
            ...
            <table align="center">
                <tr>
                    ...
                    <td><input type="text" name="rollNo" placeholder="Enter RollNo" size="23"
                ...
                <tr><th style="padding: 3px"></th></tr>
                  ...
                  <td><input type="number" name="physics" maxlength="3" placeholder="Enter Physics Marks"  style="width:190px"
                ...
                <tr>
                    <th align="left">Chemistry<span style="color: red">*</span> :</th>
                     <td><input type="number" name="chemistry" maxlength="3" placeholder="Enter Chemistry Marks"  style="width:190px"
                ...
                <tr >
                  ...
                  <td><input type="number" name="maths" maxlength="3" placeholder="Enter Maths Marks"  style="width:190px"
