       ...
       <%
            ...
            <table width="90%" align="center">
                 ...
                 <label>First Name : </label> 
                 	<input type="text" name="firstName" placeholder="Enter First Name" Size= "23" value="<%=ServletUtility.getParameter("firstName", request)%>">
					&nbsp;
                 	<label>Last Name : </label> 
    	             <input type="text" name="lastName" placeholder="Enter Last Name" Size= "23" value="<%=ServletUtility.getParameter("lastName", request)%>">
                    &nbsp;
                 	<label>EmailId : </label> 
    	             <input type="text" name="email" placeholder="Enter Email Id" Size= "23" value="<%=ServletUtility.getParameter("email", request)%>">
                    &nbsp; 
            ...
            <table border="1" width="100%" align="center" cellpadding=2px cellspacing=".2">
                ...
                <input type="checkbox" id="select_all" name="select">Select All</th>
                <th>S.No.</th>
                <th>College</th>
                <th>First Name</th>
                <th>Last Name</th>
