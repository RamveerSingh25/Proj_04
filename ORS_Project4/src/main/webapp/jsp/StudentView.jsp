...
<body>
	  ...
	  <tr><th style="padding: 3px"></th></tr>    	
		...
		<td style="position: fixed"><font  color="red"><%=ServletUtility.getErrorMessage("lastname", request)%></font>
		 ...
		 <tr>
          ...
          <td><input type="text" name="dob" id="udate4" readonly="readonly" placeholder="Date of Birth" size="23"  value="<%=DataUtility.getDateString(bean.getDob())%>"></td> 
   ...
   <tr><th style="padding: 3px"></th></tr>    
		...
		<td><input type="text" name="email" placeholder="Enter Email Id" size="23" value="<%=DataUtility.getStringData(bean.getEmail())%>"></td>
