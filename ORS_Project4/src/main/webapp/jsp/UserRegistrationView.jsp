		...
		<div align="center">
			<table>
				...
				<tr>
					...
					<td><input type="text" name="login" placeholder="Enter Valid Email Id" size="23" value="<%=DataUtility.getStringData(bean.getLogin())%>"></td>
				...
				<tr>
					...
					<td><input type="text" name="dob" id="datepicker" readonly="readonly" size="23" placeholder="Enter DOB" value="<%=DataUtility.getDateString(bean.getDob())%>"></td>
				...
				<tr>
					...
					<td><input type="text" name="mobileNo" placeholder="Enter Mobile No" size="23" maxlength="10" value="<%=DataUtility.getStringData(bean.getMobileNo())%>"></td>
