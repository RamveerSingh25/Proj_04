...
<body>
	<form action="<%=ORSView.LOGIN_CTL%>" method="post">
		...
		<%
			...
			System.out.print("Getting Uri in LoginView" + uri);
		%>
		...
		<center>
			...
			<table>
				<tr>
					...
					<td><input type="text" name="login" size=23 autocomplete="off" placeholder="Enter Your Email Id" value="<%=DataUtility.getStringData(bean.getLogin())%>">
						<font style="position: fixed" color="red">&nbsp; <%=ServletUtility.getErrorMessage("login", request)%></font></td>
				</tr>
				<tr>
					<th>Password<font color="red">*</font> :</th>
					<td><input type="password" name="password" size=23 placeholder="Enter Your Password" value="<%=DataUtility.getStringData(bean.getPassword())%>">
				...
				<tr>
					<th></th>
					<td><a href="<%=ORSView.FORGET_PASSWORD_CTL%>"><b>Forgot my password</b></a>&nbsp;</td>
				</tr>
			</table>
	</form>
	</center>
